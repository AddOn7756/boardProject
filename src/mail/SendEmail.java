...
public class SendEmail {
	...
	public boolean sendTempPw(String email, String tempPw) {
		 String host     = "smtp.naver.com";
		  ...
		  try {
		   MimeMessage message = new MimeMessage(session);
		   message.setFrom(new InternetAddress("dlvgusvwns@naver.com","Add-on")); //msg.setFrom(new InternetAddress(mymail, "HAH 관리자"));
		   message.addRecipient(Message.RecipientType.TO, new InternetAddress(to));
...
//			addArray[0] = new InternetAddress("taehee129@naver.com");
//			addArray[1] = new InternetAddress("dlvgusvwns@naver.com");
